...
from .CSharpCode矿簇 import HarmonyPatch_Prefix_Parameter


def Start():
    HarmonyPatch_Prefix_Parameter(MinerComponent, "InitVeinArray", preparameter=Prefix0) # void InitVeinArray(int vcnt)
    HarmonyPatch_Prefix_Default(MinerComponent, "ArrangeVeinArray", prefunc=Prefix1) # void ArrangeVeinArray()
